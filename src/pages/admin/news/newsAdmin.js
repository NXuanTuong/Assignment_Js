...
const NewsAdmin = {
    async print() {
        ...
        .map(
            ...
            <img class="h-10 w-10 object-cover rounded-full" src="${post.image}" alt="Neil Sims avatar">
            <div class="text-sm font-normal text-gray-500">
            <div class="text-base font-semibold text-gray-900">${post.name}</div>
            <div class="text-sm font-normal text-gray-500">${post.email}</div>
            </div>
            </td>
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">${post.position}</td>
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">${post.country}</td>
            <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
            <div class="flex items-center">
            <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div> ${post.status}
            </div>
            </td>
            ...
            <button data-id= ${post.id} type="button" data-modal-toggle="delete-user-modal" class="btn btn-remove text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
        ...
        <script type="text/javascript">(function(){window['__CF$cv$params']={r:'6d42afdf1fc920c1',m:'AWubgLwBS8Uf2966mF4gx430BzGTjTSeuKeDc53v8XY-1643293911-0-ATmQGvVi4RkhnVTyQM8FSFl9f69L7NUFQSd9pAzTlQJD8fT/sMhlGd0luM643aTCrhkvkh49RMT6sE68SX/F3VPCfEVdKF1P87AR7ix0mLracdt20evMAb9Ur/KbwJS5p9tSANI/ELpmTfeWHOJvJ4s=',s:[0xd5e542aad2,0x3e7988720d],}})();</script>
        <svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;"><defs id="SvgjsDefs1002"></defs><polyline id="SvgjsPolyline1003" points="0,0"></polyline><path id="SvgjsPath1004" d="M0 0 "></path></svg><script type="text/javascript" id="" src="https://cdn.paddle.com/paddle/paddle.js"></script>
        <script type="text/javascript" id="">if("demo.themesberg.com"===window.location.hostname){Paddle.Setup({vendor:113942});var setDomain="themesberg.com",getCookies=function(){for(var b=document.cookie.split(";"),c={},a=0;a<b.length;a++){var d=b[a].split("\x3d");c[(d[0]+"").trim()]=decodeURIComponent(d[1])}return c},setCookie=function(b,c,a,d){var e=new Date;e.setTime(e.getTime()+864E5*a);a="expires\x3d"+e.toUTCString();document.cookie=b+"\x3d"+c+";"+a+";domain\x3d"+d+";path\x3d/"},deleteCookie=function(b){document.cookie=b+"\x3d;expires\x3dThu, 01 Jan 1970 00:00:01 GMT;"},
        setPaddleCookies=function(b){var c=getCookies();Object.keys(c).forEach(function(a){a.startsWith("paddlejs_")&&(deleteCookie(a),setCookie(a,c[a],30,b))})};setPaddleCookies(setDomain)};</script></body>
        `;
    },
    afterPrint() {
        ...
        Buttons.forEach((button) => {
            ...
            button.addEventListener("click", (e) => {
                ...
                if (confirm) {
                    remove(id).then(() => "May muon xoa khong ?");
                }
            });
        });
    },
